...
def patch():
    ...
    new_decode = (
        ...
        "            # Interleave heads: [r0_heads, r1_heads] -> [r0_h0, r1_h0, ...]\n"
        "            q_nope_ag = q_nope_ag.view(-1, self.dcp_size, layer.tp_q_head_num, layer.v_head_dim)\n"
        "            q_nope_ag = q_nope_ag.transpose(1, 2).contiguous()\n"
        "            q_nope_ag = q_nope_ag.view(-1, layer.tp_q_head_num * self.dcp_size, layer.v_head_dim)\n"
        "            q_rope_ag = q_rope_ag.view(-1, self.dcp_size, layer.tp_q_head_num, rope_dim)\n"
        "            q_rope_ag = q_rope_ag.transpose(1, 2).contiguous()\n"
        "            q_rope_ag = q_rope_ag.view(-1, layer.tp_q_head_num * self.dcp_size, rope_dim)\n"
        "\n"
